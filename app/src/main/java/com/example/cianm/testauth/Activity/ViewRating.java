...
public class ViewRating extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentPlayer = ((GlobalVariables) ViewRating.this.getApplication()).getCurrentPlayer();
        currentTeam = ((GlobalVariables) ViewRating.this.getApplication()).getCurrentTeam();
        currentEvent = ((GlobalVariables) ViewRating.this.getApplication()).getCurrentEvent();
        setTitle("Ratings for: " + currentPlayer);
       ...
       // getNames();
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent (ViewRating.this, ManagerHome.class);
    ...
    public void loadRatings(){
        if(currentTeam.contains("H")){
            ...
            mUserRef.orderByChild("name").equalTo(currentPlayer).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        userUid = ds.getKey();
                        //mRatingRef = FirebaseDatabase.getInstance().getReference("Ratings").child(currentTeam).child("Fixture");
                        mRatingRef.child(userUid).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for (DataSnapshot ds : dataSnapshot.getChildren()) {
